...
<body>
    ...
    <div class="title">
        ...
        <form method="post" class="box" action="" name="signup-form">
            ...
            <input type="password" name="password2" id="passwd2" placeholder="Confirmar Contraseña" required/><br>
            ...
            <div id="info"></div>
            <input type="submit" name="register" value="register">Register</input>
        </form>
</body>
</html>
